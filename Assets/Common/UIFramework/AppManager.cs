...
public class AppManager : MonoBehaviour
{
    ...
    private void OnSingleTapped()
    {
        if (mActiveViewType == ViewType.ARCAMERAVIEW)
        {
            ...
            MeshRenderer marker = GameObject.Find("UserDefinedTarget").GetComponentInChildren<MeshRenderer>();
            ...
            worldPosition.x -= marker.bounds.size.x * tempScreenPosition.x / Screen.width;
            worldPosition.y += marker.bounds.size.y * (1 - tempScreenPosition.y / Screen.height);
